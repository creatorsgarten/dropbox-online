...
<div class="space-y-3">
  ...
  <div class="space-y-2">
    ...
    <input
      type="file"
      bind:files
      class="h-8 overflow-visible text-xs font-light text-gray-600 file:mr-2 file:cursor-pointer file:rounded-lg file:border-none file:bg-green-200 file:px-3 file:py-1 file:text-xs file:font-light file:shadow-md file:shadow-green-100"
    />
  </div>
